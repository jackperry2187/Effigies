...
public class DefaultSettings {
    ...
    //?} else {
    /*public static final ChatFormatting defaultTitleColor = ChatFormatting.DARK_AQUA;
    public static final ChatFormatting defaultMessageColor = ChatFormatting.AQUA;

    private static final Message initialMessage = new Message(
            Component.literal("Gentle Reminders Enabled").withStyle(defaultTitleColor),
            Component.literal("Gentle Reminders is enabled. You will receive mindful messages every " + timeBetweenMessages + " minutes.").withStyle(defaultMessageColor),
            true
    );
    ...
    public static final List<Message> defaultMessages = new ArrayList<>(Arrays.asList(
            ...
            generateSimpleMessage("You're doing wonderfully - celebrate that!"),
            generateSimpleMessage("You're on a great path - keep going!"),
            generateUniqueMessage("You're doing great!", "Keep up the good work!", true, ChatFormatting.GREEN, ChatFormatting.DARK_GREEN),
            generateUniqueMessage("You're amazing!", "Don't forget it!", true, ChatFormatting.LIGHT_PURPLE, ChatFormatting.DARK_PURPLE),
            generateUniqueMessage("Have a wonderful day!", "You deserve it!", true, ChatFormatting.BLUE, ChatFormatting.DARK_BLUE),
            generateUniqueMessage("Take on the world!", "You're unstoppable!", true, ChatFormatting.RED, ChatFormatting.DARK_RED),
            generateUniqueMessage("Shine bright today!", "You're a star!", true, ChatFormatting.YELLOW, ChatFormatting.GOLD),
            generateUniqueMessage("Embrace the journey!", "Every moment counts!", true, ChatFormatting.BLUE, ChatFormatting.LIGHT_PURPLE),
            generateUniqueMessage("You're a champion!", "Keep up the good work!", true, ChatFormatting.RED, ChatFormatting.DARK_RED),
            generateUniqueMessage("You're a rockstar!", "You're doing amazing!", true, ChatFormatting.RED, ChatFormatting.GREEN),
            generateUniqueMessage("Feel the flow of progress!", "Trust the process!", true, ChatFormatting.AQUA, ChatFormatting.BLUE),
            generateUniqueMessage("Look at how talented you are!", "You've created something amazing!", true, ChatFormatting.LIGHT_PURPLE, ChatFormatting.DARK_PURPLE),
            generateUniqueMessage("You're a creative genius!", "Your ideas are incredible!", true, ChatFormatting.GREEN, ChatFormatting.GOLD),
            generateUniqueMessage("Believe in your magic!", "You're capable of anything!", true, ChatFormatting.DARK_PURPLE, ChatFormatting.LIGHT_PURPLE),
            generateUniqueMessage("You're a work of art!", "You're beautiful inside and out!", true, ChatFormatting.BLUE, ChatFormatting.LIGHT_PURPLE),
            generateUniqueMessage("You are enough!", "Just as you are.", true, ChatFormatting.WHITE, ChatFormatting.GRAY),
            generateUniqueMessage("Stay true to you!", "You're on the right path!", true, ChatFormatting.DARK_GRAY, ChatFormatting.WHITE),
            generateUniqueMessage("Your hard work is paying off!", "Keep it up!", true, ChatFormatting.DARK_GREEN, ChatFormatting.GREEN),
            generateUniqueMessage("You're a ray of sunshine!", "Brightening the world!", true, ChatFormatting.YELLOW, ChatFormatting.GOLD),
            generateUniqueMessage("You're a breath of fresh air!", "Refreshing the world!", true, ChatFormatting.AQUA, ChatFormatting.BLUE),
            generateUniqueMessage("You're a guiding light!", "Illuminating the world!", true, ChatFormatting.DARK_PURPLE, ChatFormatting.LIGHT_PURPLE),
            generateUniqueMessage("You're a force of nature!", "Changing the world!", true, ChatFormatting.GREEN, ChatFormatting.RED),
            generateUniqueMessage("This is a Unique Message", "And you're a wonderfully unique person!", true, ChatFormatting.GOLD, ChatFormatting.YELLOW),
            generateUniqueMessage("Believe in Yourself!", "You're stronger than you think!", true, ChatFormatting.DARK_BLUE, ChatFormatting.AQUA),
            generateUniqueMessage("You're on the Right Path", "Trust your journey.", true, ChatFormatting.GOLD, ChatFormatting.DARK_PURPLE),
            generateUniqueMessage("Embrace Your Potential", "You're capable of amazing things!", true, ChatFormatting.DARK_PURPLE, ChatFormatting.GREEN),
            generateUniqueMessage("Shine On!", "Your inner light is brilliant!", true, ChatFormatting.YELLOW, ChatFormatting.AQUA),
            generateUniqueMessage("Feel the Positivity", "Let it fill your heart.", true, ChatFormatting.AQUA, ChatFormatting.GREEN),
            generateUniqueMessage("Breathe in Strength", "You are resilient!", true, ChatFormatting.DARK_AQUA, ChatFormatting.RED),
            generateUniqueMessage("You've Got This!", "Trust your instincts.", true, ChatFormatting.DARK_RED, ChatFormatting.GOLD),
            generateUniqueMessage("Radiate Kindness", "You make the world brighter.", true, ChatFormatting.LIGHT_PURPLE, ChatFormatting.GREEN),
            generateUniqueMessage("Celebrate Progress", "Every step counts!", true, ChatFormatting.GREEN, ChatFormatting.BLUE),
            generateUniqueMessage("Keep the Faith", "Good things are coming.", true, ChatFormatting.DARK_GREEN, ChatFormatting.DARK_BLUE),
            generateUniqueMessage("Spark Your Creativity", "Your ideas are brilliant!", true, ChatFormatting.LIGHT_PURPLE, ChatFormatting.DARK_PURPLE),
            generateUniqueMessage("Be Your Own Hero", "You have what it takes!", true, ChatFormatting.RED, ChatFormatting.YELLOW),
            generateUniqueMessage("You're In Control", "Guide your thoughts with love.", true, ChatFormatting.DARK_BLUE, ChatFormatting.WHITE),
            generateUniqueMessage("Appreciate Your Journey", "It's uniquely yours.", true, ChatFormatting.DARK_GREEN, ChatFormatting.GREEN),
            generateUniqueMessage("Keep Exploring", "Your curiosity leads to growth.", true, ChatFormatting.AQUA, ChatFormatting.BLUE),
            generateUniqueMessage("Stay Courageous", "Your bravery is inspiring.", true, ChatFormatting.DARK_RED, ChatFormatting.BLUE),
            generateUniqueMessage("Stay Hopeful", "The best is yet to come.", true, ChatFormatting.BLUE, ChatFormatting.YELLOW),
            generateUniqueMessage("Appreciate Your Growth", "Look at how far you've come!", true, ChatFormatting.GREEN, ChatFormatting.DARK_GREEN),
            generateUniqueMessage("Choose Joy Today", "It's within reach.", true, ChatFormatting.LIGHT_PURPLE, ChatFormatting.GOLD),
            generateUniqueMessage("Inspire Change", "Your actions make a difference.", true, ChatFormatting.DARK_PURPLE, ChatFormatting.DARK_GREEN),
            generateUniqueMessage("Cherish This Moment", "You'll never live it again.", true, ChatFormatting.BLUE, ChatFormatting.DARK_BLUE),
            generateUniqueMessage("Love Your Uniqueness", "You bring something special.", true, ChatFormatting.WHITE, ChatFormatting.AQUA),
            generateUniqueMessage("Stay Optimistic", "The world is full of possibilities.", true, ChatFormatting.YELLOW, ChatFormatting.BLUE),
            generateUniqueMessage("Seek Inspiration", "It's all around you.", true, ChatFormatting.GREEN, ChatFormatting.GOLD),
            generateUniqueMessage("Stay Curious", "It's the key to learning.", true, ChatFormatting.DARK_PURPLE, ChatFormatting.DARK_BLUE),
            generateUniqueMessage("Steve Jobs:", "The only way to do great work is to love what you do.", true, ChatFormatting.GOLD, ChatFormatting.DARK_BLUE),
            generateUniqueMessage("Theodore Roosevelt:", "Believe you can and you're halfway there.", true, ChatFormatting.YELLOW, ChatFormatting.DARK_GREEN),
            generateUniqueMessage("Mahatma Gandhi:", "You must be the change you wish to see in the world.", true, ChatFormatting.GOLD, ChatFormatting.GREEN),
            generateUniqueMessage("Sam Levenson:", "Don't watch the clock; do what it does. Keep going.", true, ChatFormatting.GRAY, ChatFormatting.DARK_BLUE),
            generateUniqueMessage("Robert Frost:", "The best way out is always through.", true, ChatFormatting.DARK_RED, ChatFormatting.DARK_GREEN),
            generateUniqueMessage("George Eliot:", "It is never too late to be what you might have been.", true, ChatFormatting.DARK_GREEN, ChatFormatting.GOLD),
            generateUniqueMessage("Pablo Picasso:", "Everything you can imagine is real.", true, ChatFormatting.LIGHT_PURPLE, ChatFormatting.DARK_PURPLE),
            generateUniqueMessage("Robin Williams:", "No matter what people tell you - words and ideas can change the world.", true, ChatFormatting.DARK_RED, ChatFormatting.RED),
            generateUniqueMessage("Lewis Carroll:", "In the end - we only regret the chances we didn't take.", true, ChatFormatting.AQUA, ChatFormatting.DARK_BLUE),
            generateUniqueMessage("Norman Vaughan:", "Dream big and dare to fail.", true, ChatFormatting.LIGHT_PURPLE, ChatFormatting.DARK_GRAY),
            generateUniqueMessage("Milton Berle:", "If opportunity doesn't knock - build a door.", true, ChatFormatting.YELLOW, ChatFormatting.GOLD),
            generateUniqueMessage("Walt Disney:", "All our dreams can come true - if we have the courage to pursue them.", true, ChatFormatting.BLUE, ChatFormatting.YELLOW),
            generateUniqueMessage("Nelson Mandela:", "It always seems impossible until it's done.", true, ChatFormatting.GRAY, ChatFormatting.DARK_AQUA),
            generateUniqueMessage("Albert Einstein:", "A person who never made a mistake never tried anything new.", true, ChatFormatting.DARK_PURPLE, ChatFormatting.LIGHT_PURPLE),
            generateUniqueMessage("Mae Jemison:", "Never limit yourself because of others' limited imagination.", true, ChatFormatting.DARK_GREEN, ChatFormatting.GOLD),
            generateUniqueMessage("Bo Bennett:", "Success is not in what you have - but who you are.", true, ChatFormatting.DARK_GREEN, ChatFormatting.GREEN)
    ));
    *///?}
}
