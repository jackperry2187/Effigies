...
import static jackperry2187.gentlereminders.commands.client.ArgumentInit.registerNeoForgeCommands;

@OnlyIn(Dist.CLIENT)
public class RegisterCommands {
    public static void onRegisterClientCommands(RegisterClientCommandsEvent event) {
        CommandDispatcher<CommandSourceStack> dispatcher = event.getDispatcher();
        registerNeoForgeCommands(dispatcher);
    }

    public static void registerClientCommands() {
        // Registration happens via event in GentleRemindersNeoForge
    }

    public static void registerArguments() {
        // NeoForge doesn't need custom argument registration for basic types
    }
}
*///?}
