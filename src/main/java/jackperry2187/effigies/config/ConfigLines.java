...
public final class ConfigLines {
    ...
    public static List<String> getBaseConfigLines() {
        List<String> lines = new ArrayList<>(Arrays.asList(
            ...
            "",
            "### General Settings",
            "# Whether to give the grimoire to a player the first time they join the world.",
            "# It will still be craftable.",
            "give_grimoire_on_join=" + GIVE_GRIMOIRE_ON_JOIN,
            "",
            "### Pike Radius Values",
            ...
            "# The Anti-Pike spawns its mob instead of preventing it, acting like a custom spawner.",
            "# Spawn delays are measured in ticks (20 ticks = 1 second).",
            "# Ranges are measured in blocks. All values must be 1 or greater.",
            "",
            "# Minimum delay between spawn cycles",
            "anti_pike_min_spawn_delay=" + ANTI_PIKE_MIN_SPAWN_DELAY,
            "",
            "# Maximum delay between spawn cycles (should be greater than the minimum)",
            "anti_pike_max_spawn_delay=" + ANTI_PIKE_MAX_SPAWN_DELAY,
            "",
            "# Maximum number of the same mob nearby before spawning pauses (density cap)",
            "anti_pike_max_nearby_entities=" + ANTI_PIKE_MAX_NEARBY_ENTITIES,
            "",
            "# Horizontal block radius around the Anti-Pike that mobs can spawn in",
            "anti_pike_spawn_range=" + ANTI_PIKE_SPAWN_RANGE,
            "",
            "# How close (in blocks) a player must be for the Anti-Pike to activate",
            "anti_pike_activation_range=" + ANTI_PIKE_ACTIVATION_RANGE,
            "",
            "### Dimension Whitelist",
            "# Comma-separated list of dimensions where spawn prevention is allowed to work.",
            "# Leave empty to affect ALL dimensions (default behavior).",
            "# Uses namespace:id format. Example: dimension_whitelist=minecraft:overworld,minecraft:the_nether",
            "dimension_whitelist=" + String.join(",", DIMENSION_WHITELIST),
            "",
